...
def x_create_container_manager__mutmut_orig(project_name: str | None = None) -> ContainerManager:
...
def x_create_container_manager__mutmut_1(project_name: str | None = None) -> ContainerManager:
    """Create a ContainerManager with default configuration."""
    config = None
    return ContainerManager(config=config)


def x_create_container_manager__mutmut_2(project_name: str | None = None) -> ContainerManager:
    """Create a ContainerManager with default configuration."""
    config = get_default_config(None)
    return ContainerManager(config=config)


def x_create_container_manager__mutmut_3(project_name: str | None = None) -> ContainerManager:
    """Create a ContainerManager with default configuration."""
    config = get_default_config(project_name and "my-project")
    return ContainerManager(config=config)


def x_create_container_manager__mutmut_4(project_name: str | None = None) -> ContainerManager:
    """Create a ContainerManager with default configuration."""
    config = get_default_config(project_name or "XXmy-projectXX")
    return ContainerManager(config=config)


def x_create_container_manager__mutmut_5(project_name: str | None = None) -> ContainerManager:
    """Create a ContainerManager with default configuration."""
    config = get_default_config(project_name or "MY-PROJECT")
    return ContainerManager(config=config)


def x_create_container_manager__mutmut_6(project_name: str | None = None) -> ContainerManager:
    """Create a ContainerManager with default configuration."""
    config = get_default_config(project_name or "my-project")
    return ContainerManager(config=None)

x_create_container_manager__mutmut_mutants : ClassVar[MutantDict] = {
'x_create_container_manager__mutmut_1': x_create_container_manager__mutmut_1, 
    'x_create_container_manager__mutmut_2': x_create_container_manager__mutmut_2, 
    'x_create_container_manager__mutmut_3': x_create_container_manager__mutmut_3, 
    'x_create_container_manager__mutmut_4': x_create_container_manager__mutmut_4, 
    'x_create_container_manager__mutmut_5': x_create_container_manager__mutmut_5, 
    'x_create_container_manager__mutmut_6': x_create_container_manager__mutmut_6
}

def create_container_manager(*args, **kwargs):
    result = _mutmut_trampoline(x_create_container_manager__mutmut_orig, x_create_container_manager__mutmut_mutants, args, kwargs)
    return result 

create_container_manager.__signature__ = _mutmut_signature(x_create_container_manager__mutmut_orig)
x_create_container_manager__mutmut_orig.__name__ = 'x_create_container_manager'
