...
def x__get_shell_integration_script_path__mutmut_orig() -> Path:
...
def x__get_shell_integration_script_path__mutmut_1() -> Path:
    """Get the path to the shell integration script.
...
def x__get_shell_integration_script_path__mutmut_2() -> Path:
    """Get the path to the shell integration script.
...
def x__get_shell_integration_script_path__mutmut_3() -> Path:
    """Get the path to the shell integration script.

    Returns:
        Path to shell-integration.sh in the repository root
    """
    return Path(None).parent.parent.parent.parent.parent / "scripts" / "shell-integration.sh"


def x__get_shell_integration_script_path__mutmut_4() -> Path:
    """Get the path to the shell integration script.

    Returns:
        Path to shell-integration.sh in the repository root
    """
    return Path(__file__).parent.parent.parent.parent.parent / "XXscriptsXX" / "shell-integration.sh"


def x__get_shell_integration_script_path__mutmut_5() -> Path:
    """Get the path to the shell integration script.
...
def x__get_shell_integration_script_path__mutmut_6() -> Path:
    """Get the path to the shell integration script.

    Returns:
        Path to shell-integration.sh in the repository root
    """
    return Path(__file__).parent.parent.parent.parent.parent / "scripts" / "XXshell-integration.shXX"


def x__get_shell_integration_script_path__mutmut_7() -> Path:
    """Get the path to the shell integration script.
...
x__get_shell_integration_script_path__mutmut_mutants : ClassVar[MutantDict] = {
'x__get_shell_integration_script_path__mutmut_1': x__get_shell_integration_script_path__mutmut_1, 
    'x__get_shell_integration_script_path__mutmut_2': x__get_shell_integration_script_path__mutmut_2, 
    'x__get_shell_integration_script_path__mutmut_3': x__get_shell_integration_script_path__mutmut_3, 
    'x__get_shell_integration_script_path__mutmut_4': x__get_shell_integration_script_path__mutmut_4, 
    'x__get_shell_integration_script_path__mutmut_5': x__get_shell_integration_script_path__mutmut_5, 
    'x__get_shell_integration_script_path__mutmut_6': x__get_shell_integration_script_path__mutmut_6, 
    'x__get_shell_integration_script_path__mutmut_7': x__get_shell_integration_script_path__mutmut_7
}

def _get_shell_integration_script_path(*args, **kwargs):
    result = _mutmut_trampoline(x__get_shell_integration_script_path__mutmut_orig, x__get_shell_integration_script_path__mutmut_mutants, args, kwargs)
    return result 

_get_shell_integration_script_path.__signature__ = _mutmut_signature(x__get_shell_integration_script_path__mutmut_orig)
x__get_shell_integration_script_path__mutmut_orig.__name__ = 'x__get_shell_integration_script_path'
