...
class UvManager(BaseToolManager):
    ...
    def xǁUvManagerǁget_available_versions__mutmut_2(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "XXhttps://api.github.com/repos/astral-sh/uv/releasesXX"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_18(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_19(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_20(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_21(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_22(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_23(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_24(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_25(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_26(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_27(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_28(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_29(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_30(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_31(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_32(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_33(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    def xǁUvManagerǁget_available_versions__mutmut_34(self) -> list[str]:
        """Get available UV versions from GitHub releases."""
        try:
            api_url = "https://api.github.com/repos/astral-sh/uv/releases"
            data = self.fetch_json_secure(api_url)
    ...
    'xǁUvManagerǁget_available_versions__mutmut_1': xǁUvManagerǁget_available_versions__mutmut_1, 
        ...
        'xǁUvManagerǁget_available_versions__mutmut_18': xǁUvManagerǁget_available_versions__mutmut_18, 
        'xǁUvManagerǁget_available_versions__mutmut_19': xǁUvManagerǁget_available_versions__mutmut_19, 
        'xǁUvManagerǁget_available_versions__mutmut_20': xǁUvManagerǁget_available_versions__mutmut_20, 
        'xǁUvManagerǁget_available_versions__mutmut_21': xǁUvManagerǁget_available_versions__mutmut_21, 
        'xǁUvManagerǁget_available_versions__mutmut_22': xǁUvManagerǁget_available_versions__mutmut_22, 
        'xǁUvManagerǁget_available_versions__mutmut_23': xǁUvManagerǁget_available_versions__mutmut_23, 
        'xǁUvManagerǁget_available_versions__mutmut_24': xǁUvManagerǁget_available_versions__mutmut_24, 
        'xǁUvManagerǁget_available_versions__mutmut_25': xǁUvManagerǁget_available_versions__mutmut_25, 
        'xǁUvManagerǁget_available_versions__mutmut_26': xǁUvManagerǁget_available_versions__mutmut_26, 
        'xǁUvManagerǁget_available_versions__mutmut_27': xǁUvManagerǁget_available_versions__mutmut_27, 
        'xǁUvManagerǁget_available_versions__mutmut_28': xǁUvManagerǁget_available_versions__mutmut_28, 
        'xǁUvManagerǁget_available_versions__mutmut_29': xǁUvManagerǁget_available_versions__mutmut_29, 
        'xǁUvManagerǁget_available_versions__mutmut_30': xǁUvManagerǁget_available_versions__mutmut_30, 
        'xǁUvManagerǁget_available_versions__mutmut_31': xǁUvManagerǁget_available_versions__mutmut_31, 
        'xǁUvManagerǁget_available_versions__mutmut_32': xǁUvManagerǁget_available_versions__mutmut_32, 
        'xǁUvManagerǁget_available_versions__mutmut_33': xǁUvManagerǁget_available_versions__mutmut_33, 
        'xǁUvManagerǁget_available_versions__mutmut_34': xǁUvManagerǁget_available_versions__mutmut_34
    }
    ...
    def xǁUvManagerǁ_install_from_archive__mutmut_orig(self, archive_path: pathlib.Path, version: str) -> None:
        ...
        try:
            ...
            shutil.copy2(uv_binary, target_path)
    ...
    def xǁUvManagerǁverify_installation__mutmut_31(self, version: str) -> bool:
        """Verify that UV installation works and version matches."""
        binary_path = self.get_binary_path(version)
        if not binary_path.exists():
            logger.error(f"UV binary not found at {binary_path}")
    ...
    def xǁUvManagerǁverify_installation__mutmut_32(self, version: str) -> bool:
        """Verify that UV installation works and version matches."""
        binary_path = self.get_binary_path(version)
        if not binary_path.exists():
            logger.error(f"UV binary not found at {binary_path}")
    ...
    def xǁUvManagerǁverify_installation__mutmut_33(self, version: str) -> bool:
        """Verify that UV installation works and version matches."""
        binary_path = self.get_binary_path(version)
        if not binary_path.exists():
            logger.error(f"UV binary not found at {binary_path}")
    ...
    'xǁUvManagerǁverify_installation__mutmut_1': xǁUvManagerǁverify_installation__mutmut_1, 
        ...
        'xǁUvManagerǁverify_installation__mutmut_31': xǁUvManagerǁverify_installation__mutmut_31, 
        'xǁUvManagerǁverify_installation__mutmut_32': xǁUvManagerǁverify_installation__mutmut_32, 
        'xǁUvManagerǁverify_installation__mutmut_33': xǁUvManagerǁverify_installation__mutmut_33
    }
