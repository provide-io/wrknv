...
class TestConfigurationError:
    ...
    def test_config_error_with_line_number(self):
...
class TestProfileError:
    ...
    def test_profile_not_found_default_message(self):
    ...
    def test_profile_error_with_custom_message(self):
    ...
    def test_profile_error_with_available_profiles(self):
...
class TestToolNotFoundError:
    ...
    def test_tool_not_found_without_version(self):
    ...
    def test_tool_not_found_with_version(self):
    ...
    def test_tool_not_found_with_few_available_versions(self):
    ...
    def test_tool_not_found_with_many_available_versions(self):
...
class TestDependencyError:
    ...
    def test_single_dependency_missing(self):
    ...
    def test_multiple_dependencies_missing(self):
    ...
    def test_dependency_error_with_required_for(self):
    ...
    def test_python3_dependency(self):
...
class TestCommandNotFoundError:
    ...
    def test_command_not_found_without_suggestions(self):
...
class TestWorkenvError:
    ...
    def test_workenv_error_without_path(self):
    ...
    def test_workenv_error_with_path(self):
...
class TestContainerError:
    ...
    def test_container_error_without_name(self):
    ...
    def test_container_error_with_name(self):
