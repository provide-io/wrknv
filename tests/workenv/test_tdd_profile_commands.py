...
from wrkenv.env.cli import workenv_profile
...
tools = {}
        ...
        runner = CliRunner()
        with patch(
            "wrkenv.env.config.WorkenvConfig._find_soup_toml",
...
tools = {}
        ...
        with patch(
            ...
            with patch("pathlib.Path.home", return_value=tmp_path):
                with patch("wrkenv.env.config.tomli_w"):  # Mock the writer
...
tofu = "1.9.0"
        ...
        with patch(
            ...
            with patch("wrkenv.env.cli.get_tool_manager") as mock_manager:
...
tofu = "1.7.0"
        ...
        with patch(
            ...
            with patch("wrkenv.env.cli.get_tool_manager") as mock_manager:
                ...
                with patch("wrkenv.env.config.tomli_w"):
