...
class TestVolumeCommands:
    ...
    def mock_manager(self, mock_home, test_config):
        ...
        with patch("wrknv.container.commands.ContainerManager") as MockManager:
            ...
            manager.get_container_path = Mock(side_effect=lambda p="": mock_home / ".wrknv" / "containers" / "test-project-dev" / p)
    ...
    def test_backup_volumes_command(self, mock_manager, test_config, mock_home, capsys):
        ...
        # Setup mock backup
        backup_path = mock_home / ".wrknv" / "containers" / "test-project-dev" / "backups" / "backup-20250831-150000.tar.gz"
    ...
    def test_backup_volumes_with_name(self, mock_manager, test_config, mock_home, capsys):
        ...
        backup_path = mock_home / ".wrknv" / "containers" / "test-project-dev" / "backups" / "custom-backup.tar.gz"
        backup_path.parent.mkdir(parents=True, exist_ok=True)
    ...
    def test_clean_volumes_with_preserve(self, mock_manager, test_config):
        ...
        assert result is True
        mock_manager.clean_volumes.assert_called_once_with(
