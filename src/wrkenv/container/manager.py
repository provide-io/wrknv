...
class ContainerManager:
    ...
    def start(self, force_rebuild: bool = False) -> bool:
        ...
        cmd = [
            ...
            "-v", f"{home_dir}:/host-home",
            "-v", "/var/run/docker.sock:/var/run/docker.sock",
            "-e", f"HOST_USER={os.environ.get('USER', 'user')}",
    ...
    def enter(self, command: Optional[List[str]] = None) -> None:
    ...
    def stop(self) -> bool:
        ...
        try:
            ...
            self.console.print(f"[green]✅ Container stopped successfully[/green]")
            return True
        except subprocess.CalledProcessError as e:
    ...
    def clean(self) -> bool:
        ...
        if self.container_exists():
            try:
                ...
                self.console.print(f"[green]✅ Container removed[/green]")
            except subprocess.CalledProcessError:
                self.console.print(f"[red]❌ Failed to remove container[/red]")
                return False
        ...
        if self.image_exists():
            try:
                ...
                self.console.print(f"[green]✅ Image removed[/green]")
            except subprocess.CalledProcessError:
                self.console.print(f"[yellow]⚠️  Failed to remove image (may be in use)[/yellow]")
