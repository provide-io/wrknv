...
def get_venv_python_version(venv_dir: Path) -> Optional[Dict[str, any]]:
...
def get_project_python_requirement() -> Optional[str]:
...
def should_recreate_venv(venv_dir: Path, project_requirement: Optional[str]) -> Tuple[bool, Optional[str]]:
...
def read_venv_python_version(venv_dir: Path) -> Optional[str]:
