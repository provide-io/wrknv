...
class ProjectDetector:
    ...
    def scan_directory(self, path: Path, max_depth: int = 5):
        """
    ...
    def _scan_recursive(self, path: Path, current_depth: int, max_depth: int):
    ...
    def _check_pattern(self, filename: str, is_dir: bool):
