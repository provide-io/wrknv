...
class ContainerManager:
    ...
    def __attrs_post_init__(self):
        ...
        self.runtime = DockerRuntime(runtime_name="docker", runtime_command=runtime_command)
    ...
    def start(self, **options) -> bool:
        ...
        return self.lifecycle.start(create_if_missing=True, **options)
    ...
    def exec_command(self, command: list[str], **kwargs) -> str | None:
        ...
        return self.exec.run_command(command=command, capture_output=True, **kwargs)
