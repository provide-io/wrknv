...
from wrknv.wenv.exceptions import ContainerError
...
class ContainerLifecycle:
    ...
    def stop(self, timeout: int) -> bool:
        ...
        try:
            ...
            self.console.print(
                f"[green]✅ Container {self.container_name} stopped successfully[/green]"
            )
            return True
    ...
    def remove(self, force: bool) -> bool:
        ...
        try:
            if not self.runtime.container_exists(self.container_name):
                self.console.print(
                    f"[yellow]⚠️  Container {self.container_name} does not exist[/yellow]"
                )
                return True
            ...
            self.console.print(
                f"🗑️  Removing container {self.container_name}..."
            )
            
            self.runtime.remove_container(self.container_name, force=force)
            
            self.console.print(
                f"[green]✅ Container {self.container_name} removed successfully[/green]"
            )
            return True
